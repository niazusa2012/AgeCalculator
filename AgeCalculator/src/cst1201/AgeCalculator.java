...
public class AgeCalculator {
    ...
    public static void main(String[] args) {
        ...
        String word = "will be", word2 = "years";

        //Finally, display the user's age in this year, but only if it's valid.
        if (newAge >= 0) {
            if (newAge == 1) {
                word2 = "year"; // extra credit 2
                word = "were"; // extra credit 3
            } else if (newAge < currentAge) {
                word = "were";
            }
            System.out.println("You " + word + " " + newAge + " " + word2 + " old in "
                    + anotherYear + ".");
        } else {
            System.out.println("Invalid age, Please try agian"); // extra credit 1
        }
